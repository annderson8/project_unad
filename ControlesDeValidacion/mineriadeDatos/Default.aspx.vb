...
Partial Class mineriadeDatos_Default
    ...
    End Sub
    Protected Sub MButton6_Click(sender As Object, e As EventArgs) Handles MButton6.Click
        Response.Redirect("Softwares.aspx")
    End Sub
